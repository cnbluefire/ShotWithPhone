    ...
    sealed partial class App : Application
    {
        ...
        protected override void OnLaunched(LaunchActivatedEventArgs e)
        {
            ...
            if (rootFrame == null)
            {
                ...
                {
                    SystemNavigationManager.GetForCurrentView().AppViewBackButtonVisibility = AppViewBackButtonVisibility.Visible;//在窗口左上角显示返回按钮
                }
                else
                {
                    SystemNavigationManager.GetForCurrentView().AppViewBackButtonVisibility = AppViewBackButtonVisibility.Collapsed;//在窗口左上角显示返回按钮
                }
            }
        ...
        protected override async void OnActivated(IActivatedEventArgs args)
        {
            try
            {
                ...
                if (args.Kind == ActivationKind.ToastNotification)
                {
                    ...
                    if (toastactiveargs == "" || toastactiveargs == null) return;
